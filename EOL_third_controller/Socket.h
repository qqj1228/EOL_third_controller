...
protected:
	...
	Socket_Base(SOCKET s, const bool bTCP);
...
public:
	SocketServer(int port, const bool bTCP, int connections, TypeSocket type);
...
class SocketSelect {
public:
	SocketSelect(Socket_Base const * const s1, Socket_Base const * const s2, TypeSocket type);
